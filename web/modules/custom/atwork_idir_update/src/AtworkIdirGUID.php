...
//    $return_value = "The system did not record and update or create user " . $this_user->field_user_display_name->value;
    $return_value = "The system did not record and update or create user " . $this_user->field_full_name->value ;
    if ($result == 1) {
//      $return_value = 'New user ' . $this_user->field_user_display_name->value . ' created';
      $return_value = 'New user ' . $this_user->field_full_name->value . ' created' ;
    }
    if ($result == 2) {
//      $return_value = 'User ' . $this_user->field_user_display_name->value . ' Updated';
      $return_value = 'User '. $this_user->field_full_name->value . ' Updated' ;
    }
    return $return_value;
  }
